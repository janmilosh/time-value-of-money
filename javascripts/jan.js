function calculatePresentValue() {
	var presentValue;
	var numberOfMonths = document.getElementById('numberOfMonths3').value;
	var monthlyPayment = document.getElementById('monthlyPayment3').value;
	monthlyPayment = monthlyPayment.replace(/[^\d\.\-\ ]/g, '');
	var yearlyInterest = document.getElementById('yearlyInterest3').value;
...
function calculateMonthlyPayment() {
	var monthlyPayment;
	var presentValue = document.getElementById('presentValue1').value;
	presentValue = presentValue.replace(/[^\d\.\-\ ]/g, '');
	var numberOfMonths = document.getElementById('numberOfMonths1').value;
	var yearlyInterest = document.getElementById('yearlyInterest1').value;
	var monthlyInterest = yearlyInterest/1200;
...
function calculateNumberOfMonths() {
	var numberOfMonths;
	var presentValue = document.getElementById('presentValue2').value;
	presentValue = presentValue.replace(/[^\d\.\-\ ]/g, '');
	var monthlyPayment = document.getElementById('monthlyPayment2').value;
	monthlyPayment = monthlyPayment.replace(/[^\d\.\-\ ]/g, '');
	var yearlyInterest = document.getElementById('yearlyInterest2').value;
	var monthlyInterest = yearlyInterest/1200;
	if (yearlyInterest > 0) {
